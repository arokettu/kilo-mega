...
class BytesTest extends TestCase
{
    public function testBytes(): void
    {
        ...
        self::assertEquals('1.21 KiB', format_bytes(1234));
        self::assertEquals('12.1 KiB', format_bytes(12345));
        self::assertEquals('121 KiB', format_bytes(123456));
        self::assertEquals('1.18 MiB', format_bytes(1234567));
        self::assertEquals('11.8 MiB', format_bytes(12345678));
        self::assertEquals('118 MiB', format_bytes(123456789));
        self::assertEquals('1.15 GiB', format_bytes(1234567890));

        // all other prefixes
        self::assertEquals('1.12 TiB', format_bytes(1.234e12));
        self::assertEquals('1.10 PiB', format_bytes(1.234e15));
        self::assertEquals('1.07 EiB', format_bytes(1.234e18));
        self::assertEquals('1.05 ZiB', format_bytes(1.234e21));
        self::assertEquals('1.02 YiB', format_bytes(1.234e24));
        self::assertEquals('1021 YiB', format_bytes(1.234e27)); // < 1024
        self::assertEquals('10.0 RiB', format_bytes(1.234e28));
        self::assertEquals('997 RiB', format_bytes(1.234e30)); // < 1024
        self::assertEquals('9.73 QiB', format_bytes(1.234e31));
        ...
        // over max
        self::assertEquals('970299 QiB', format_bytes(1.23e36));
        self::assertEquals('9702989134 QiB', format_bytes(1.23e40)); // scale overflow
    }
    ...
    public function testBytesNeg(): void
    {
        self::assertEquals('-1 B', format_bytes(-1));
        self::assertEquals('-12 B', format_bytes(-12));
        self::assertEquals('-123 B', format_bytes(-123));
    ...
    public function testBytesFixedNeg(): void
    {
        self::assertEquals('-1 B', format_bytes(-1, fixedWidth: true));
        self::assertEquals('-12 B', format_bytes(-12, fixedWidth: true));
        self::assertEquals('-123 B', format_bytes(-123, fixedWidth: true));
