...
final class MetricIntTest extends TestCase
{
    public function testMetric(): void
    {
        ...
        self::assertEquals('1.23 kB', format_metric(1234, onlyIntegers: true));
        self::assertEquals('12.3 kB', format_metric(12345, onlyIntegers: true));
        self::assertEquals('123 kB', format_metric(123456, onlyIntegers: true));
        self::assertEquals('1.23 MB', format_metric(1234567, onlyIntegers: true));
        self::assertEquals('12.3 MB', format_metric(12345678, onlyIntegers: true));
        self::assertEquals('123 MB', format_metric(123456789, onlyIntegers: true));
        self::assertEquals('1.23 GB', format_metric(1234567890, onlyIntegers: true));

        // all other prefixes
        self::assertEquals('1.23 TB', format_metric(1.234e12, onlyIntegers: true));
        self::assertEquals('1.23 PB', format_metric(1.234e15, onlyIntegers: true));
        self::assertEquals('1.23 EB', format_metric(1.234e18, onlyIntegers: true));
        self::assertEquals('1.23 ZB', format_metric(1.234e21, onlyIntegers: true));
        self::assertEquals('1.23 YB', format_metric(1.234e24, onlyIntegers: true));
        self::assertEquals('1.23 RB', format_metric(1.234e27, onlyIntegers: true)); // < 1024
        self::assertEquals('12.3 RB', format_metric(1.234e28, onlyIntegers: true));
        self::assertEquals('1.23 QB', format_metric(1.234e30, onlyIntegers: true)); // < 1024
        ...
        // max
        self::assertEquals('123 QB', format_metric(1.23e32, onlyIntegers: true));
        // over max
        self::assertEquals('1230000 QB', format_metric(1.23e36, onlyIntegers: true));
        self::assertEquals('12300000000 QB', format_metric(1.23e40, onlyIntegers: true)); // scale overflow
    }
    ...
    public function testMetricNeg(): void
    {
        self::assertEquals('-1 B', format_metric(-1, onlyIntegers: true));
        self::assertEquals('-12 B', format_metric(-12, onlyIntegers: true));
        self::assertEquals('-123 B', format_metric(-123, onlyIntegers: true));
    ...
    public function testMetricFixedNeg(): void
    {
        self::assertEquals('-1 B', format_metric(-1, onlyIntegers: true, fixedWidth: true));
        self::assertEquals('-12 B', format_metric(-12, onlyIntegers: true, fixedWidth: true));
        self::assertEquals('-123 B', format_metric(-123, onlyIntegers: true, fixedWidth: true));
