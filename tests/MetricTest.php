...
class MetricTest extends TestCase
{
    ...
    {
        self::assertEquals('1.00 B', format_metric(1));
        self::assertEquals('12.0 B', format_metric(12));
        self::assertEquals('123 B', format_metric(123));
        self::assertEquals('1.23 kB', format_metric(1234));
        self::assertEquals('12.3 kB', format_metric(12345));
        self::assertEquals('123 kB', format_metric(123456));
        self::assertEquals('1.23 MB', format_metric(1234567));
        self::assertEquals('12.3 MB', format_metric(12345678));
        self::assertEquals('123 MB', format_metric(123456789));
        self::assertEquals('1.23 GB', format_metric(1234567890));

        // all other prefixes
        self::assertEquals('1.23 TB', format_metric(1.234e12));
        self::assertEquals('1.23 PB', format_metric(1.234e15));
        self::assertEquals('1.23 EB', format_metric(1.234e18));
        self::assertEquals('1.23 ZB', format_metric(1.234e21));
        self::assertEquals('1.23 YB', format_metric(1.234e24));
        self::assertEquals('1.23 RB', format_metric(1.234e27)); // < 1024
        self::assertEquals('12.3 RB', format_metric(1.234e28));
        self::assertEquals('1.23 QB', format_metric(1.234e30)); // < 1024
        self::assertEquals('12.3 QB', format_metric(1.234e31));

        // max
        self::assertEquals('123 QB', format_metric(1.23e32));
        // over max
        self::assertEquals('1230000 QB', format_metric(1.23e36));
        self::assertEquals('12300000000 QB', format_metric(1.23e40)); // scale overflow
    }
    ...
    {
        self::assertEquals('1.23 B', format_metric(1.2345e0));
        self::assertEquals('123 mB', format_metric(1.2345e-1));
        self::assertEquals('12.3 mB', format_metric(1.2345e-2));
        self::assertEquals('1.23 mB', format_metric(1.2345e-3));
        self::assertEquals('123 μB', format_metric(1.2345e-4));
        self::assertEquals('12.3 μB', format_metric(1.2345e-5));
        self::assertEquals('1.23 μB', format_metric(1.2345e-6));
        self::assertEquals('123 nB', format_metric(1.2345e-7));
        self::assertEquals('12.3 nB', format_metric(1.2345e-8));
        self::assertEquals('1.23 nB', format_metric(1.2345e-9));

        // all other prefixes
        self::assertEquals('1.23 pB', format_metric(1.234e-12));
        self::assertEquals('1.23 fB', format_metric(1.234e-15));
        self::assertEquals('1.23 aB', format_metric(1.234e-18));
        self::assertEquals('1.23 zB', format_metric(1.234e-21));
        self::assertEquals('1.23 yB', format_metric(1.234e-24));
        self::assertEquals('1.23 rB', format_metric(1.234e-27));
        self::assertEquals('1.23 qB', format_metric(1.234e-30));

        // zero
        self::assertEquals('0.00 B', format_metric(0));
        // min
        self::assertEquals('0.12 qB', format_metric(1.23e-31));
        // below min
        self::assertEquals('0.00 qB', format_metric(1.23e-36));
        // scale overflow
        self::assertEquals('0.00 qB', format_metric(1.23e-40));
    }
